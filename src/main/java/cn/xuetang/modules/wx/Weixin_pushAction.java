...
public class Weixin_pushAction extends BaseAction {
    ...
    @At("")
    @Ok("->:/private/wx/Weixin_push.html")
    ...
    @At
    @Ok("->:/private/wx/Weixin_pushAdd.html")
    ...
    @At
    @Ok("->:/private/wx/Weixin_pushView.html")
    ...
    public boolean deleteIds(@Param("ids") Integer[] ids) {
        //daoCtl.delete(dao, Weixin_push_content.class, Cnd.where("pushid", "in", ids));
        //删除push时，还原图文资料
