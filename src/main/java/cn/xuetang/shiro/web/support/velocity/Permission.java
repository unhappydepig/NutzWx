	...
	public Object getPrincipalProperty(String property) {
		...
		if (subject != null) {
			...
			try {
				...
				logger.tracef("Property [{}] not found in principal of type [{}]", property, principal.getClass().getName());
			} catch (Exception e) {
				logger.tracef("Error reading property [{}] from principal of type [{}]", property, principal.getClass().getName());
			}
		}
