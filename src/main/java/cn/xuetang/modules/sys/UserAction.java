...
public class UserAction {
	...
	@At
	@Ok("json")
	public Message updateInfo(@Attr(Webs.ME) Sys_user olduser, @Attr(Webs.ME) Sys_user user, @Param("userid") String userid, @Param("password2") String pass, @Param("oldpassword") String oldpassword, HttpServletRequest req) {
