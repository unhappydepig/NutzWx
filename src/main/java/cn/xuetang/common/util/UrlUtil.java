...
public class UrlUtil {
	 ...
	 * 读取一个网页全部内容
	 */
	public static String getOneHtml(final String htmlurl, String encoding) throws IOException {
		URL url;
		String temp;
	 ...
	 * @return
	 */
	public static String readStreamParameterBase64(ServletInputStream in) {
		StringBuilder buffer = new StringBuilder();
		BufferedReader reader = null;
		try {
			reader = new BufferedReader(new InputStreamReader(in));
